...
print("Test 1 (glm-5.2 explicit prompt):")
print(test_payload("accounts/aimodel/models/glm-5.2", "Search the internet for the top news headline globally for today, July 27, 2026."))

print("\nTest 2 (claude-opus-4.8 explicit prompt):")
print(test_payload("accounts/aimodel/models/claude-opus-4.8", "Search the internet for the top news headline globally for today, July 27, 2026."))
