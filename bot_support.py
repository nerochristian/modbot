"""
ModBot Support - Tickets, Modmail & Utilities Bot
Entry point for support features
"""
...
def setup_logging() -> logging.Logger:
    ...
    logger = logging.getLogger("ModBotSupport")
...
# ==================== BOT CLASS ====================
class ModBotSupport(commands.Bot):
    """
    Support Bot - handles tickets, modmail, utilities, admin, staff, court.
    ...
    def __init__(self):
        ...
        self.version: str = "3.3.0-Support"
    ...
    async def setup_hook(self):
        logger.info("🔧 Initializing ModBot Support...")
        ...
        cogs = [
            ...
            "cogs.staff",
            "cogs.court",
            "cogs.logging_cog",  # Needed for support logging
        ...
        logger.info("=" * 60)
        logger.info(f"📦 Support Bot Cog Summary: ✅ {len(loaded)} | ❌ {len(failed)}")
    ...
    async def on_ready(self):
        ...
        logger.info("=" * 60)
        logger.info(f"🎫 ModBot Support Online: {self.user}")
        ...
        await self.change_presence(
            activity=discord.Activity(
                ...
                name="support requests | /ticket",
            ),
            status=discord.Status.online,
        )
        
        logger.info("🚀 ModBot Support is operational!")
    ...
    async def close(self):
        logger.info("👋 Shutting down ModBot Support...")
        try:
...
async def main() -> int:
    ...
    if not token:
        logger.critical("❌ DISCORD_TOKEN_SUPPORT not found!")
        logger.critical("Add DISCORD_TOKEN_SUPPORT=your_token to .env")
        return 1
    ...
    try:
        async with bot:
            logger.info("🚀 Starting ModBot Support...")
            await bot.start(token)
    except KeyboardInterrupt:
        logger.info("👋 Shutdown signal received")
    except discord.LoginFailure:
        logger.critical("❌ Invalid DISCORD_TOKEN_SUPPORT!")
        return 1
    except Exception as e:
