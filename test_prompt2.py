...
print("Test (claude-fable-5 explicit prompt):")
print(test_payload("accounts/aimodel/models/claude-fable-5", "Search the internet for the top news headline globally for today, July 27, 2026."))
