...
const RAID: Row[] = [
  {
    id: 1,
    user: "user4821",
    content: "@everyone free nitro → grabnitro.gg",
    verdict: "blocked",
    reason: "scam link",
  },
  {
    id: 2,
    user: "user9033",
    content: "free nitro here!! discocl.aim/gift",
    verdict: "blocked",
    reason: "scam link",
  },
  {
    id: 3,
    user: "g1ftdrop",
    content: "CLAIM NOW steamcommunlty.ru",
    verdict: "blocked",
    reason: "phishing",
  },
  {
    id: 4,
    user: "user1102",
    content: "@everyone @everyone @everyone",
    verdict: "blocked",
    reason: "mention flood",
  },
  {
    id: 5,
    user: "nitr0_bot",
    content: "free nitro → grabnitro.gg",
    verdict: "blocked",
    reason: "scam link",
  },
  {
    id: 6,
    user: "user7740",
    content: "join disc0rd.gift/xyz for free",
    verdict: "blocked",
    reason: "invite spam",
  },
  {
    id: 7,
    user: "freegift88",
    content: "steamcommunlty.ru/claim",
    verdict: "blocked",
    reason: "phishing",
  },
  {
    id: 8,
    user: "user2251",
    content: "FREE NITRO FREE NITRO FREE",
    verdict: "flagged",
    reason: "caps + repeat",
  },
];
...
export function LiveWire() {
  ...
  useEffect(() => {
    ...
    timers.push(
      setTimeout(
        () => setSettled(true),
        700 + (RAID.length - 3) * ROW_INTERVAL + 400,
      ),
    );
      ...
      <div className="relative overflow-hidden rounded-2xl border border-border bg-card/90 shadow-2xl shadow-black/20">
        ...
        <div
          ...
          style={{
            ...
            WebkitMaskImage:
              "linear-gradient(to bottom, transparent 0, #000 56px)",
          }}
        >
          <ul className="flex flex-col justify-end gap-2">
            {visible.map((row) => (
              ...
              >
                <span className="font-mono text-[0.6875rem] font-medium text-muted">
                  {row.user}
                </span>
