...
export const MODULE_DEFINITIONS: readonly ModuleDefinition[] = [
  ...
  },
  {
    id: 'welcome',
    name: 'Welcome Card',
    description: 'Greet new members with a consistent reference-style welcome image and your server’s chosen background.',
    category: 'Engagement',
    icon: 'image-plus',
    badge: 'new',
    ...
    fields: [
      ...
      { key: 'welcome_bg_url', label: 'Background image URL', type: 'url', placeholder: 'https://…/background.png', hint: 'Use a direct HTTPS image URL. Leave empty to fall back to the member banner or avatar.' },
    ],
  },
  {
    id: 'autoroles',
