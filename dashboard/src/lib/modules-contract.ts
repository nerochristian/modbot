...
export const MODULE_DEFINITIONS: readonly ModuleDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      { key: 'verification_method', label: 'Verification method', type: 'select', fallback: 'discord', hint: 'Members verify inside Discord with Docket\'s image CAPTCHA.', options: [{ label: 'Discord captcha', value: 'discord' }] },
